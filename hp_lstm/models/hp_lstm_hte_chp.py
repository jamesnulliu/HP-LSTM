...
class HP_LSTM_hte_chp(nn.Module):
    def __init__(
        self,
        input_size: int,
        hidden_size: int,
        ...
        super(HP_LSTM_hte_chp, self).__init__()
    ...
    def forward(
        ...
        # chp
        c_detached = hawkes_t + f_t * c_detached + i_t * torch.tanh(self.W_c(x) + self.U_c(h_detached) + self.b_c)
